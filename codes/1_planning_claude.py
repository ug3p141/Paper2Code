...
import os
import sys
from utils import print_response, print_log_cost_claude, load_accumulated_cost, save_accumulated_cost
...
for idx, instruction_msg in enumerate([plan_msg, file_list_msg, task_list_msg, config_msg]):
    ...
    completion = api_call(trajectories, claude_model)
